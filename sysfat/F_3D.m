function F = F_3D(Nx, Ny, Nz, Nt, Nresp, Nc, varargin)
%function F = F_3D(Nx, Ny, Nz, Nt, Nresp, Nc,i varargin)
%
...
display('currently not passing test_adjoint! use GsplineF_5D instead')
...
if isempty(arg.samp)
        F = fatrix2('idim', squeeze([arg.Nx arg.Ny arg.Nz arg.Nt arg.Nresp arg.Nc]), 'arg', arg, ...
                ...
                @F_3D_forw, 'back', @F_3D_back);
else
        F = fatrix2('idim', squeeze([arg.Nx arg.Ny arg.Nz arg.Nt arg.Nresp arg.Nc]), 'arg', arg, ...
                'odim', [arg.Ns arg.Nt], 'forw', @F_3D_forw, ...
                'back', @F_3D_back);
