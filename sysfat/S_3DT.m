...
% if (arg.Nc > 1)
% 	if (arg.Nt > 1)
% 		S = fatrix2('idim', [arg.Nx arg.Ny arg.Nt] ,'arg',arg,'odim', ...
% 			[arg.Nx arg.Ny arg.Nt arg.Nc], 'forw', @S_3DT_forw, ...
% 			'back', @S_3DT_back, 'imask', arg.mask);
% 	else
% 		S = fatrix2('idim', [arg.Nx arg.Ny] ,'arg',arg,'odim', ...
% 			[arg.Nx arg.Ny 1 arg.Nc], 'forw', @S_3DT_forw, ...
% 			'back', @S_3DT_back, 'imask', arg.mask);
% 	end
% else
% 	S = fatrix2('idim', [arg.Nx arg.Ny arg.Nt] ,'arg',arg,'odim', ...
% 		[arg.Nx arg.Ny arg.Nt], 'forw', @S_3DT_forw, 'back', ...
% 		@S_3DT_back, 'imask', arg.mask);
% end

S = fatrix2('idim', squeeze([arg.Nx arg.Ny arg.Nz arg.Nt]) ,'arg',arg,'odim', ...
        squeeze([arg.Nx arg.Ny arg.Nz arg.Nt arg.Nc]), 'forw', @S_3DT_forw, ...
        'back', @S_3DT_back, 'imask', arg.mask);
