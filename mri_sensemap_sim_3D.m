 function [smap x y z] = mri_sensemap_sim_3D(varargin)
...
%|
%| option
%|	nx, ny, nz, dx, dy, dz, ncoil, coils_per_ring, rcoil, coil_distance, orbit (see below)
%|
%| out
...
[ring_smap x y z] = mri_sensemap_sim_do(arg.nx, arg.ny, arg.nz, arg.dx, arg.dy, arg.dz, ...
	arg.coils_per_ring, arg.coils_per_ring, arg.rcoil, arg.orbit, arg.coil_distance, ...
...
% note: mri_sensemap_sim_do can only handle coil center locations along unit sphere
% mri_sensemap_sim_do()
function [smap x y z] = mri_sensemap_sim_do(nx, ny, nz, dx, dy, dz, ncoil, ncoilpr,  rcoil, ...
	...
	for jj = 1:nring
		for ii=1:ncoilpr
			...
			[sx sy sz] = mri_smap1(xr, yr, zr, rlist((jj-1)*ncoilpr + ii)); % in coil coordinates
...
function mri_sensemap_sim_show(smap, x, y, z, dx, dy, dz, nlist, plist, rlist)
